...
#     }
  ...
  colleges=["You should consider going to a technical school.<br><br><br> Not to be confused with a tech school, Tech schools often offer heavily based science and engineering degrees. Tech schools can have a wide range of undergraduate students ranging from 2,000 all the way to 30,000 students.", 
